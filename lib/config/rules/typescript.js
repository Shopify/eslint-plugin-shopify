...
module.exports = {
  ...
  // enforces the use of the keyword namespace over module to declare custom TypeScript modules. (no-internal-module from TSLint) <FEEDBACK>
  ...
  /**
   * eslint rules to disable for typescript
   */
