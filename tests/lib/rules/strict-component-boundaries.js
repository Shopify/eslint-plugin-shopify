  ...
  valid: [
    {
      ...
      parserOptions,
      filename: fixtureFile('strict-component-boundaries/app/index.js'),
    },
    {
      code: `import {someThing} from '../Bar';`,
      parserOptions,
      filename: fixtureFile(
        'strict-component-boundaries/app/components/Foo/index.js',
      ),
    },
    {
      ...
      parserOptions,
      filename: fixtureFile(
        'strict-component-boundaries/app/sections/MySection/MySection.js',
      ),
    },
    {
